...
// VictoryBanner — a native <dialog> via useModalDialog, no onClose since
// (like VictoryBanner) the only way out is significant enough that it
...
export function BarbarianAttackModal({
  ...
  // which never attaches the ref — showModal() on a non-modal banner that
