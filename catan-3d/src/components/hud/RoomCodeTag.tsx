export function RoomCodeTag({ roomCode }: { roomCode: string }) {
  return (
    <div className="pointer-events-none self-start rounded-lg border border-glass-border bg-glass px-2.5 py-1.5 shadow-[0_8px_30px_rgba(0,0,0,0.35)] backdrop-blur-xl">
