...
// stepper buttons, until/unless dedicated art gets made for them too.
export const PARCHMENT_BUTTON =
  'rounded-md border border-[#8a6d47] bg-[#d9c49a]/90 text-[#2b1810] shadow-[inset_0_1px_0_rgba(255,255,255,0.35),0_1px_2px_rgba(43,24,16,0.3)] transition-colors hover:bg-[#e3d0a8]'
