...
import { buildHexBoard, buildHexBoardFromCells, BOARD_SHAPES, type Biome, type BoardShapeId } from './hexBoard'
...
describe('seafarersBasic board shape', () => {
  ...
  it('only seafarersBasic ever produces sea or gold tiles', () => {
    for (const shapeId of Object.keys(BOARD_SHAPES) as BoardShapeId[]) {
